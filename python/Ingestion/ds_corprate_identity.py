...
character_id = con.sql("SELECT DISTINCT issuer_id FROM 'data/dng_contracts_current.json'").fetchall()
...
con = duckdb.connect("md:glitter_sword")
acceptor_id = con.sql("SELECT DISTINCT acceptor_id FROM 'data/dng_contracts_current.json'").fetchall()
